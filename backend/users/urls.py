...
from .views import RegisterView, LoginView, ProfileView, UserProfileUpdateView, profile_completion,update_password,AuthenticatedUserView
...
urlpatterns = [
    ...
    path('me/', AuthenticatedUserView.as_view(), name='user-me'),
